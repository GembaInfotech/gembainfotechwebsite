...
var sendEmail = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(contactData) {
    var fullName, email, phoneNumber, company, service_type, request_description, fileName, filePath, transporter, mailOptions, info;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          mailOptions = {
            ...
            text: "\n      Full Name: ".concat(fullName, "\n      Email: ").concat(email, "\n      Service Type: ").concat(service_type, "\n      Request Description: ").concat(request_description, "\n    "),
            replyTo: email,
